...
;;
;; To get a development environment (inside emacs shell will work)
;;
;;   guix shell -D -f guix.scm
;;
;; Note that a container does not work right now with rust.
;;
  ...
  (package
    ...
    (inputs
     `(
       ...
       ("openmpi" ,openmpi)
       ("python" ,python) ; for python-ffi bindings
       ("rust" ,rust)
    ...
    (native-inputs
     `(
       ("nss-certs" ,nss-certs) ; for cargo
       ("openssl" ,openssl)     ; for cargo
